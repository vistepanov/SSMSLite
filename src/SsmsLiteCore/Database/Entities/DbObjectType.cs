...
namespace SsmsLite.Core.Database.Entities
{
    public class DbObjectType
    {
        ...
        public static readonly DbObjectType USER_TABLE_COLUMN = new DbObjectType("USER_TABLE_COLUMN", DbSimplifiedType.Column); // Not an sql type
        public static readonly DbObjectType VIEW = new DbObjectType("VIEW", DbSimplifiedType.View);
        public static readonly DbObjectType AGGREGATE_FUNCTION = new DbObjectType("AGGREGATE_FUNCTION", DbSimplifiedType.Function);
        ...
        public static readonly DbObjectType SQL_SCALAR_FUNCTION = new DbObjectType("SQL_SCALAR_FUNCTION", DbSimplifiedType.Function);
        public static readonly DbObjectType SQL_TABLE_VALUED_FUNCTION = new DbObjectType("SQL_TABLE_VALUED_FUNCTION", DbSimplifiedType.Function);
        ...
        public static readonly DbObjectType SQL_STORED_PROCEDURE = new DbObjectType("SQL_STORED_PROCEDURE", DbSimplifiedType.Procedure);
        public static readonly DbObjectType CHECK_CONSTRAINT = new DbObjectType("CHECK_CONSTRAINT", DbSimplifiedType.Constraint);
        public static readonly DbObjectType DEFAULT_CONSTRAINT = new DbObjectType("DEFAULT_CONSTRAINT", DbSimplifiedType.Constraint);
        ...
        public static readonly DbObjectType SQL_TRIGGER = new DbObjectType("SQL_TRIGGER", DbSimplifiedType.Trigger);
        public static readonly DbObjectType INDEX_CLUSTERED = new DbObjectType("INDEX CLUSTERED", DbSimplifiedType.Index); // Not an sql type
        public static readonly DbObjectType INDEX_NONCLUSTERED = new DbObjectType("INDEX NONCLUSTERED", DbSimplifiedType.Index); // Not an sql type
        public static readonly DbObjectType SYNONYM = new DbObjectType("SYNONYM", DbSimplifiedType.Other);
        ...
        public DbSimplifiedType Category { get; }
